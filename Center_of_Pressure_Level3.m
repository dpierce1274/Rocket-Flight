...
Cr = 13.75;             % Fin root chord (in)
Ct = 3.5;               % Fin tip chord (in)
S = 4.5;                % Fin semispan (in)
Lf = 4.5;               % Length of fin mid-chord line (in)
R = 2.00;               % Radius of body at aft end (in)
Xr = 7.51;              % Distance between fin root leading edge and fin tip leading edge parallel to body (in)
Xb = 76.75;             % Distance from nose tip to fin root chord leading edge (in)
N = 3;                  % Number of fins
